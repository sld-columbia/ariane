...
#define TEST_NFU_1IN_1OUT( testnum, nfu, config, result, val1, slot1, slot2, slot3) \
    TEST_CASE( testnum, x1, result, \
      set_load_nfu nfu, slot1,  slot2,  slot3; \
      li  x1, MASK_XLEN(val1); \
      exec_nfu nfu, config; \
      pop_nfu nfu, x1, 0; \
    )

#define TEST_NFU_2IN_1OUT( testnum, nfu, config, result, val1, val2 ) \
    TEST_CASE( testnum, x1, result, \
      set_load_nfu nfu, 1,  2,  0; \
      li  x1, MASK_XLEN(val1); \
...
#define TEST_NFU_3IN_1OUT( testnum, nfu, config, result, val1, val2, val3, slot1, slot2, slot3 ) \
    TEST_CASE( testnum, x1, result, \
      set_load_nfu nfu, slot1,  slot2,  slot3; \
      li  x1, MASK_XLEN(val1); \
      li  x2, MASK_XLEN(val2); \
...
#define TEST_NFU_3IN_SPACING6_1OUT( testnum, nfu, config, result, val1, val2, val3, slot1a, slot1b, slot2a, slot2b, slot3 ) \
    TEST_CASE( testnum, x1, result, \
      set_load_nfu nfu, slot1a,  slot1b,  0; \
      li  x1, MASK_XLEN(val1); \
      set_load_nfu nfu, slot2a, slot2b, slot3; \
      li  x2, MASK_XLEN(val2); \
      li  x3, MASK_XLEN(val3); \
      exec_nfu nfu, config; \
      pop_nfu nfu, x1, 0; \
...
#define TEST_NFU_3IN_SPACING7_1OUT( testnum, nfu, config, result, val1, val2, val3, slot1a, slot1b, slot2a, slot2b, slot3a, slot3b ) \
    TEST_CASE( testnum, x1, result, \
      set_load_nfu nfu, slot1a,  slot1b,  0; \
      li  x1, MASK_XLEN(val1); \
      set_load_nfu nfu, slot2a, slot2b, 0; \
      li  x2, MASK_XLEN(val2); \
      set_load_nfu nfu, slot3a, slot3b, 0; \
      li  x3, MASK_XLEN(val3); \
      exec_nfu nfu, config; \
      pop_nfu nfu, x1, 0; \
    )

#define TEST_NFU_4IN_1OUT( testnum, nfu, config, res_addr, result, val1, val2, val3, val4 ) \
    TEST_CASE( testnum, x1, result, \
      set_load_nfu nfu, 1, 2, 3; \
      li  x1, MASK_XLEN(val1); \
      li  x2, MASK_XLEN(val2); \
      li  x3, MASK_XLEN(val3); \
      set_load_nfu nfu, 4, 0, 0; \
      li x4, MASK_XLEN(val4); \
      exec_nfu nfu, config; \
      pop_nfu nfu, x1, res_addr; \
    )
